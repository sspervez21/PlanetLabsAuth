...
type UpdateUserParams struct {
	...
	/*
	  ...
	  In: body
	*/
	UpdateUserInput *models.UserRecord
	/*
	  Required: true
	  In: path
	*/
...
func (o *UpdateUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.UserRecord
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("updateUserInput", "body"))
			} else {
				res = append(res, errors.NewParseError("updateUserInput", "body", "", err))
			}
		} else {
