...
type CreateUserParams struct {
	...
	/*
	  ...
	  In: body
	*/
	CreateUserInput *models.UserRecord
}
...
func (o *CreateUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		...
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("createUserInput", "body"))
			} else {
				res = append(res, errors.NewParseError("createUserInput", "body", "", err))
			}
		} else {
